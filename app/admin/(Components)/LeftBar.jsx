    ...
    return (
        <div className="w-[15%] bg-orange h-screen p-3 flex-col sticky top-0">
            <div className='w-full h-[93%]'>
                <Link href='/admin' className="flex space-x-1 items-center" onClick={() => setMenu('accueilC')}>
                ...
                <div className="flex-col pt-3 space-y-2">
                    <Link href='/admin' className="text-orangetxt hover:text-white" onClick={() => setMenu('accueilC')}>MENU</Link>
                    <hr className="border-orangetxt"/>
                    <ul>
                        <li>
                            <Link href="/admin/utilisateurs" className={clsx('flex space-x-5 items-center hover:bg-orangebg rounded-md p-1', {' bg-orangebg ':menu == "user"})} onClick={() => setMenu('user')}>
                                <Image src="/OIP-removebg-preview.png" alt="NC" width={40} height={40}/>
                                <h1 className="text-white text-sm">Utilisateurs</h1>
                            </Link>
                            <div className="mt-3">
                                <hr className="border-orangetxt"/>
                            </div>
                        ...
                        <li className="mt-2">
                            <Link href="/admin/NC" className={clsx('flex space-x-5 items-center hover:bg-orangebg rounded-md p-1', {' bg-orangebg ':menu == "nc"})} onClick={() => setMenu('nc')}>
                        ...
                        <li className="mt-2">
                            <Link href="/admin/dossiersDAVIEIARD" className={clsx('flex space-x-5 items-center hover:bg-orangebg rounded-md p-1', {' bg-orangebg p-1':menu == "dossierA"})} onClick={() => setMenu('dossierA')}>
                        ...
                        <li className="mt-2">
                            <Link href="/admin/profils" className={ menu == "profils" ? "flex space-x-5 items-center bg-orangebg p-1 rounded-md" : "flex space-x-5 items-center hover:bg-orangebg hover:rounded-md hover:p-1"} onClick={() => setMenu('profils')}>
