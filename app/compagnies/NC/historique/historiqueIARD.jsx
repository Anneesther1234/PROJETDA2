...
import getNCIARDComp from '../../../../lib/api/NC/IARD/getNCIARDComp'
...
export default function DetailNCIARD() {
    ...
    const handleClick = (email,societe,date) => {
        ...
        router.push('/compagnies/NC/historique/voiriard?email='+email.toString()+'&societe='+societe.toString()+'&date='+date.toString());
      };
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            const result = await  getNCIARDComp(); // Mettre getNCVIE
