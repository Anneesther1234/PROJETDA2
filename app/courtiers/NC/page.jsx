...
export default function HomeNC(){
    return(
        <>
            ...
            <HomeItems src="/plus.png" label="Nouvelle NC" href="/courtiers/NC/nouvelle"></HomeItems>
            <HomeItems src="/menu (1).png" label="Historique des NC" href="/courtiers/NC/historique" ></HomeItems>
