    ...
    return (
        <div className="w-[15%] bg-orange h-screen p-3 flex-col sticky top-0">
            <div className='w-full h-[93%]'>
                <Link href='/employeDA' className="flex space-x-1 items-center" onClick={() => setMenu('accueilC')}>
                ...
                <div className="flex-col pt-3 space-y-2">
                    <Link href='/employeDA' className="text-orangetxt hover:text-white" onClick={() => setMenu('accueilC')}>MENU</Link>
                    <hr className="border-orangetxt"/>
                    <ul>
                        <li>
                            <Link href="/employeDA/NC" className={clsx('flex space-x-5 items-center hover:bg-orangebg rounded-md p-1', {' bg-orangebg ':menu == "nc"})} onClick={() => setMenu('nc')}>
                        ...
                        <li className="mt-2">
                            <Link href="/employeDA/dossiersDAVIEIARD" className={clsx('flex space-x-5 items-center hover:bg-orangebg rounded-md p-1', {' bg-orangebg p-1':menu == "dossierA"})} onClick={() => setMenu('dossierA')}>
                        ...
                        <li className="mt-2">
                            <Link href="/employeDA/profils" className={ menu == "profils" ? "flex space-x-5 items-center bg-orangebg p-1 rounded-md" : "flex space-x-5 items-center hover:bg-orangebg hover:rounded-md hover:p-1"} onClick={() => setMenu('profils')}>
