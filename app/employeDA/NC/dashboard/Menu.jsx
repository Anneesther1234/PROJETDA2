                ...
                <div className="flex-col space-y-[10%] h-[75%] w-[80%]">
                    ...
                    <div className="flex-col h-[60%] w-full border bg-gray-200 border-gray-400">
                        ...
                        <div className="flex flex-col p-1 items-center overflow-auto h-[86%]">
                            ...
                            <label className="flex items-center">
                            <input type="radio" className="form-checkbox h-5 w-5 text-blue-600" name="annee" value="1"/>
                            <span className="ml-2 text-gray-700">2021</span>
                            </label>
                            <label className="flex items-center">
                            <input type="radio" className="form-checkbox h-5 w-5 text-blue-600" name="annee" value="2"/>
                            ...
                            <label className="flex items-center">
                            <input type="radio" className="form-checkbox h-5 w-5 text-blue-600" name="annee" value="3"/>
                            <span className="ml-2 text-gray-700">2019</span>
                            </label> <label className="flex items-center">
                            <input type="radio" className="form-checkbox h-5 w-5 text-blue-600" name="annee" value="1"/>
                            <span className="ml-2 text-gray-700">2018</span>
                            </label>
                            <label className="flex items-center">
                            <input type="radio" className="form-checkbox h-5 w-5 text-blue-600" name="annee" value="2"/>
                            <span className="ml-2 text-gray-700">2017</span>
                            </label>
                            <label className="flex items-center">
                            <input type="radio" className="form-checkbox h-5 w-5 text-blue-600" name="annee" value="3"/>
                            <span className="ml-2 text-gray-700">2016</span>
                            </label> <label className="flex items-center">
                            <input type="radio" className="form-checkbox h-5 w-5 text-blue-600" name="annee" value="1"/>
                            <span className="ml-2 text-gray-700">2015</span>
                            </label>
                            <label className="flex items-center">
                            <input type="radio" className="form-checkbox h-5 w-5 text-blue-600" name="annee" value="2"/>
                            <span className="ml-2 text-gray-700">2014</span>
                            </label>
                            <label className="flex items-center">
                            <input type="radio" className="form-checkbox h-5 w-5 text-blue-600" name="annee" value="3"/>
                            <span className="ml-2 text-gray-700">2013</span>
                            </label>
