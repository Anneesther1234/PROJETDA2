    ...
    const data = [
        {
          ...
          details:<p className="text-orange text-[15px]">Détails</p>,
      ...
      { id: <p className="text-[15px]"> 2</p>,
        ...
        details:  <Link href="/employeDA/NC/detailsVIE" > <button type="button"> <p className="text-orange text-[15px]">Détails</p>  </button></Link> ,
          fi: <button type="button"> <Image  loading="lazy" src="/telecharger.png" alt="image description" title="Télécharger le fichier" width={30} height={30}/>   </button>
      ...
      { id: <p className="text-[15px]"> 5</p>,
        ...
        details:  <Link href="/employeDA/NC/detailsNonVie" > <button type="button"> <p className="text-orange text-[15px]">Détails</p>  </button></Link> ,
        fi: <button type="button"> <Image  loading="lazy" src="/telecharger.png" alt="image description" title="Télécharger le fichier" width={30} height={30}/>   </button>
