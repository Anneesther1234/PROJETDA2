...
import getNCVIETemp from '../../../../../lib/api/NC/VIE/getNCVIETemp'
...
export default function DetailNCVIE() {
    ...
    const handleClick = (email,societe,date) => {
        ...
        router.push('/employeDA/NC/historique/voir?email='+email.toString()+'&societe='+societe.toString()+'&date='+date.toString());
      };
    ...
    const columns = [
{
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            const result = await getNCVIETemp(); // Mettre getNCVIE
